...
userSchema.index({ isDeleted: 1, accountStatus: 1, createdAt: -1, _id: -1 });
userSchema.index({ isDeleted: 1, accountStatus: 1, fullName: 1, _id: 1 });
userSchema.index({ isDeleted: 1, accountStatus: 1, isLocked: 1, createdAt: -1 });
userSchema.index({ isDeleted: 1, houseName: 1, fullName: 1 });
userSchema.index({ isDeleted: 1, familyName: 1, fullName: 1 });
